...
export default function Skill() {
  ...
  return (
    <div>
        ...
        <div className="  bg-[#1a1d52] text-white px-8   md:pt-0    flex flex-col  items-center    ">
          <div className="md:w-11/12 mx-auto text-center">
            ...
            <p className="text-sm mb-4">
              ...
              MERN stack (MongoDB, Express.js, React.js, Node.js). I have
              hands-on experience with REST APIs, state management (Redux,
              Context API), authentication systems (JWT, Firebase), and
              deploying projects to platforms like Vercel and Render.
            </p>
